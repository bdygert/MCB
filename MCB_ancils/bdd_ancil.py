    ...
    for i in rlats[k]:
        for j in rlons[k]:
            if land_frac.data[i, j] == 0.0:
                areas[k] = areas[k] + grid_areas[i, j]
#haven't adapted this because it's not relevant for me yet but i'll do it later
